package com.hafedhgaha.blog.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.hafedhgaha.blog.service.EmailAlreadyUsedException ||
            ex instanceof com.hafedhgaha.blog.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.hafedhgaha.blog.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.hafedhgaha.blog");
    }
}
